...
import ManageAjoScreen from '../screens/ManageAjoScreen'
import PayoutOrderScreen from '../screens/PayoutOrderScreen'
...
export default function AppNavigator() {
  ...
  <>
    ...
    <Stack.Screen name="ManageAjo" component={ManageAjoScreen} options={{ headerShown: false }} />
    <Stack.Screen name="PayoutOrder" component={PayoutOrderScreen} options={{ headerShown: false }} />
