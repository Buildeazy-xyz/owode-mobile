...
const styles = StyleSheet.create({
  ...
  searchInput: { flex: 1, fontSize: 15, color: '#1a2b4a' },
  ...
  emptyText: { fontSize: 18, fontWeight: 'bold', color: '#1a2b4a', marginBottom: 8, textAlign: 'center' },
  emptySubText: { fontSize: 14, color: '#7c8aa5', textAlign: 'center', lineHeight: 22 },
  ...
  membersTitle: { fontSize: 13, fontWeight: '600', color: '#1a2b4a', marginBottom: 8 },
