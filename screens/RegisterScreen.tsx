...
const styles = StyleSheet.create({
  ...
  strengthLabel: { fontSize: 12, color: '#7c8aa5' },
  strengthBar: { flex: 1, height: 4, backgroundColor: '#f0f2f7', borderRadius: 2, overflow: 'hidden' },
  ...
  loginLinkText: { color: '#7c8aa5', fontSize: 14 },
